...
import com.refCustomerFamily.databinding.LoadMoreRow2Binding;
import com.refCustomerFamily.databinding.ShopRowBinding;
...
public class NearbyAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NearbyAdapter2(List<NearbyModel.Result> placeModelList, Context context, String currency) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyHolder){
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                activity.placeItemData(placeModel1);
            });
